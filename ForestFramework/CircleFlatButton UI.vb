...
Public Class NikyusCircularFlatButton_UI
...
#Region "Declarations"
    ...
    Private _TextCheckedColor As Color
            ...
            Select Case _ButtonStyle
                Case ButtonStyle.Normal 'Normal Button
                    ...
                    Select Case State
                        Case MouseState.None
                            .FillRectangle(New SolidBrush(_BaseColour), 0, 0, Width, Height, Me.Height / 2)
                            'BorderStyle
                            If _BorderStyle = Style.None Then
                                '.DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(1, 1, Width - _BorderSize, Height - _BorderSize), Me.Height/2)

                                Dim p As New Pen(_BorderColour, _BorderSize)
                                DrawRoundedRectangle(p, G, 1, 1, Width - _BorderSize, Height - _BorderSize, Me.Height / 2)

                            ElseIf _BorderStyle = Style.Right Then
                                .DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(Width - _BorderSize, 0, _BorderSize, Height), Me.Height / 2)
                            ElseIf _BorderStyle = Style.Left Then
                                .DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(0, 0, _BorderSize, Height), Me.Height / 2)
                            ElseIf _BorderStyle = Style.Bottom Then
                                .DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(0, Height - _BorderSize, Width, _BorderSize), Me.Height / 2)
                            ElseIf _BorderStyle = Style.Top Then
                                .DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(0, 0, Width, _BorderSize), Me.Height / 2)
                            End If
                        ...
                        Case MouseState.Over
                            .FillRectangle(New SolidBrush(_BaseHoverColour), 0, 0, Width, Height, Me.Height / 2)
                            'BorderStyle
                            If _BorderStyle = Style.None Then
                                '.DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(1, 1, Width - _BorderSize, Height - _BorderSize), Me.Height/2)
                        ...
                        Case MouseState.Down
                            .FillRectangle(New SolidBrush(_PressedBaseColour), 0, 0, Width, Height, Me.Height / 2)
                            'BorderStyle
                            If _BorderStyle = Style.None Then
                                '.DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(0, 0, Width, Height), Me.Height/2)
                                Dim p As New Pen(_BorderColour, _BorderSize)
                                DrawRoundedRectangle(p, G, 1, 1, Width - _BorderSize, Height - _BorderSize, Me.Height / 2)
                            ElseIf _BorderStyle = Style.Right Then
                                .DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(Width - _BorderSize, 0, _BorderSize, Height), Me.Height / 2)
                ...
                Case ButtonStyle.ToogleButton 'Toogle Button
                    ...
                    If _Checked = True Then 'Toogle Ativo
                        ...
                        Select Case State
                            Case MouseState.None
                                .FillRectangle(New SolidBrush(_BaseCheckedColor), 0, 0, Width, Height, Me.Height / 2)
                                'BorderStyle
                                If _BorderStyle = Style.None Then
                                    '.DrawRectangle(New Pen(_BorderColour, _BorderSize), New Rectangle(1, 1, Width - _BorderSize, Height - _BorderSize), Me.Height/2)
